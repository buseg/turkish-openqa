...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--limit", type=int, default=None, help="Optional context limit for quick smoke tests.")
    ...
    with output_path.open("w", newline="", encoding="utf-8") as handle:
        ...
        for split_name in args.splits:
            for row in dataset[split_name]:
                ...
                writer.writerow([f"squad-{split_name}-{count}", row["context"], row.get("title", "")])
                count += 1
