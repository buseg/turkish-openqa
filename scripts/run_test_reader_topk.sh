...
TOPKS=(${TOPKS:-5 10 25 50 100})

CHECKPOINT_DIR="${CHECKPOINT_DIR:-${ROOT_DIR}/checkpoint/fsmodqa_off_the_shelf}"
MODEL_DIR="fanjiang98/FSMODQA-100k" #"${MODEL_DIR:-${CHECKPOINT_DIR}/checkpoint-best}"
...
RESULTS_DIR="${RESULTS_DIR:-${CHECKPOINT_DIR}/results}"
RANKING_FILE="${RANKING_FILE:-${CHECKPOINT_DIR}/test_top100.jsonl}"

DETAILED_RESULTS_DIR="${RESULTS_DIR:-${CHECKPOINT_DIR}/results/detailed}"
