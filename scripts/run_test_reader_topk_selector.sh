...
RESULTS_DIR="${RESULTS_DIR:-${CHECKPOINT_DIR}/results/results_knowledge_selector}"
RANKING_FILE="${RANKING_FILE:-${CHECKPOINT_DIR}/test_top100_selector_reranked.jsonl}"

DETAILED_RESULTS_DIR="${RESULTS_DIR:-${CHECKPOINT_DIR}/results/results_knowledge_selector/detailed}"
